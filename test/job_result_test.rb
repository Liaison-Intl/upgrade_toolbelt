...
class TestResult < MiniTest::Unit::TestCase
  ...
  def test_setting_attributes
    result = UpgradeAnalyzer::JobResult.new("jobnum", description: "description", tests: 1, passed: 2, failures: 3, errors: 4)
  ...
  def test_setting_attributes_with_string
    result = UpgradeAnalyzer::JobResult.new("jobnum", tests: "1", passed: "2", failures: "3", errors: "4")
  ...
  def test_default_attributes
    result = UpgradeAnalyzer::JobResult.new("jobnum")
  ...
  def test_passing_percent
    result = UpgradeAnalyzer::JobResult.new("jobnum", tests: 3, passed: 1)

    assert_equal 33.33, result.passing_percent
  end

  def test_divide_by_zero
    result = UpgradeAnalyzer::JobResult.new("jobnum", tests: 0, passed: 1)
  ...
  def test_adding_results
    ...
    result1 = UpgradeAnalyzer::JobResult.new("jobnum", tests: 2, passed: 3, failures: 5, errors: 7, deprecations: deprecations1)
    result2 = UpgradeAnalyzer::JobResult.new("jobnum", tests: 11, passed: 13, failures: 17, errors: 19, deprecations: deprecations2)
  ...
  def test_with_deprecations
    result = UpgradeAnalyzer::JobResult.new("jobnum", deprecations: { "warning1" => 99, "warning2" => 1 })
